...
class StreamPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.stream = models.Stream.objects.create(name="Netflix", about="#1 Platform", website="https://www.netflix.com")
...
class ReviewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.review = models.Review.objects.create(review_user=self.user, rating =5, desciption="Great Movie", watchlist=self.watchlist2, active=True)
